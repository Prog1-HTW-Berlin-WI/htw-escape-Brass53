...
public class HTWRoom implements Serializable {
    ...
    public HTWRoom(String identifier, String description, Lecturer lecturer) {
        ...
        this.rooms[0]  = new HTWRoom("TA A 021", "Seminarraum (Gebäude A)",null);
        this.rooms[1]  = new HTWRoom("TA A 026", "Seminarraum (Gebäude A)",null);
        this.rooms[2]  = new HTWRoom("TA A 027", "Seminarraum (Gebäude A)", new Lecturer("Herr Poeser"));
        this.rooms[3]  = new HTWRoom("TA C 707", "IT-/Medien-Unterrichtsraum (Gebäude C)", new Lecturer("Frau Safitri"));
        this.rooms[4]  = new HTWRoom("TA D 105", "Audimax / großer Veranstaltungsraum (Gebäude D)", new Lecturer("Vaseva"));
        this.rooms[5]  = new HTWRoom("TA D 204", "Internetcafé im Mensagebäude (Gebäude D)", new Lecturer("Gärtner"));
        this.rooms[6]  = new HTWRoom("TA A 024", "Seminar-/Unterrichtsraum (Gebäude A)", new Lecturer("Ganoui"));
